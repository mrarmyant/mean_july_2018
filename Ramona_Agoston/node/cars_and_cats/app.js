...
var server = http.createServer(function (request, response){
    ...
    else if(request.url === '/images/alfa.jpg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/alfa.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    }
    else if(request.url === '/images/peugeot.jpg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/peugeot.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    ...
    // request didn't match anything:
        ...
        response.end('URL requested not found!!!');
    }
});
